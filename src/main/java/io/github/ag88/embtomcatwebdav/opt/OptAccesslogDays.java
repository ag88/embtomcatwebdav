 ...
 */
public class OptAccesslogDays extends Opt {

	public OptAccesslogDays() {
		this.type = PropType.Prop;
		
		this.name = "accesslog.days";
		this.description = "set accesslog rotation max days (default -1, no rotate)";
		this.defaultval = -1;
		this.value = -1;
		this.opt = null;
		this.hasarg = true;
